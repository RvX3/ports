...
void renderDefault(Entity target, float thealth, float shealth, int winning, int x, int y) {
    ...
    render.text2d(target.getDisplayName(), textAreaX + TEXT_AREA_PADDING, headerY, 1f, 0xFFFFFFFF, true);
    ...
    render.text2d(winText, winTextX, headerY, 1f, 0xFFFFFFFF, true);
    
    int subheaderY = headerY + fontHeight + ROW_GAP;
    String healthText = String.format("%.1f \u2764", target.getHealth());
    render.text2d(healthText, textAreaX + TEXT_AREA_PADDING, subheaderY, 1f, getCurrentColor(0), true);
    ...
    render.text2d(diffText, diffTextX, subheaderY, 1f, diffColor, true);
...
void renderAstolfo(Entity target, float thealth, float shealth, int winning, int x, int y) {
    ...
    render.text2d(String.format("%.1f \u2764", target.getHealth()), nameX, midY, 2f, getCurrentColor(0), true);
...
void renderMyau(Entity target, float thealth, float shealth, int winning, int x, int y) {
    ...
    render.text2d(diffText, diffTextX, diffTextY, 1f, diffColor, textShadow);
